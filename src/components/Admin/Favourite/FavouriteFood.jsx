...
import { CheckCircle, Edit3, Search, XCircle, Folder, PlusCircle, Trash2, Users, User as Userr, UserX, Save, ShoppingBag, Star } from 'react-feather';
...
const FavouriteFood = () => {
  ...
  async function getItems() {
    const response = await GET(`/product/favourite/product?page=${page}&limit=${perPage}&search=${search}`)
  ...
  return (
    ...
    <Modal>
      ...
      <div className="fz20 border-bottom pl-3 py-2 my-1 d-flex align-items-center">
          <Star className='mr-2' color='#F29314' /> <span className='text-[25px]'>Favourite foods</span>
        </div>
        ...
        <table className="table table-bordered">
          <thead>
            ...
            <th className="text-center w-[30px]">#</th>
              ...
              <th className="text-center w-[150px]">Remove favourite</th>
             ...
             Array.isArray(product) ?
              ...
              return (
                <tr key={idx}>
                  ...
                  className="btn p-2 br-5 text-white d-flex align-items-center justify-content-center m-auto bh"  style={{  backgroundColor : '#FF0800' }}> <XCircle size={16} /> </button>  
                  </td>   
                  <td className='text-center'>
