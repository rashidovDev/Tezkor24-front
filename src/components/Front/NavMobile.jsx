...
import { showModalRegistration, showNavbar } from '../../store/slices/modalSlice';
import { showBasket, showNavBasket } from '../../store/slices/basketSlice';
import { FaUserCircle } from 'react-icons/fa';
import { hideProfile, showProfile } from '../../store/slices/userSlice';
          ...
          <div className={`lg:hidden ${'fixed top-0'} w-screen bg-white z-20 pb-[10px] border-b-[1px] border-[#F6F6FB] `}>
            ...
            <div className='relative w-[95%] mx-auto flex justify-center'>
              ...
              <div className='w-full flex items-center'>
                <div className='w-[75%]'>
                  <input value={search} onChange={(e) => setSearch(e.target.value)} name='search' autoComplete='off' type="text" placeholder='Search food or restaurant'
