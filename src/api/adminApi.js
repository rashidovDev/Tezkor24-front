...
async function checkToken() {
    var tokenTime = JSON.parse(localStorage.getItem('admin_tokenTime'));
    if (!tokenTime) {
	...
	// let differenceInMinutes = Math.floor((Date.now() - tokenTime) / (1000 * 60)); // Difference in minutes
    // let hours = Math.floor(differenceInMinutes / 60); // Convert minutes to hours
    // let minutes = differenceInMinutes % 60; // Remaining minutes
